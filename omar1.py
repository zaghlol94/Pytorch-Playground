...
data_transforms = {
    'train': transforms.Compose([
        ...
        transforms.ColorJitter(brightness=0.4, saturation=0.4, contrast=0.4, hue=0.3),
        transforms.ToTensor(),
...
exp_lr_scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer_ft,'min',0.1,patience= 7,verbose=True,threshold=1e-3)
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'valid']:
            ...
            if phase == 'valid' and epoch_loss < best_loss:
                ...
                best_model_wts = model.state_dict()
                torch.save(best_model_wts, os.path.join(path, 'weight_decay/valid_acc_{:.4f}.hdf5'.format(epoch_acc)))
...
plt.show()
plt.imsave('test/output1/valid_loss.png',valid_loss)
plt.imsave('test/output1/train_loss.png',train_loss)